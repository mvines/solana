...
pub const BLOB_SIZE: usize = (1500 - 128); // wikipedia says there should be 20b for ipv4 headers
...
pub const PACKETS_PER_BLOB: usize = 5; // reasonable estimate for payment packets per blob based on ~200b transaction size
